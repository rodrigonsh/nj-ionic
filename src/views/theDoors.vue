      ...
      <ion-content :fullscreen="true">
        ...
        <swiper id="walls">
          ...
          <swiper-slide class="wall">
            ...
            <ion-card @click="openDoor('1')" class="door" style="background-image: url('/images/1.png')">
              <ion-card-header>
            ...
            <ion-card @click="openDoor('2')" c class="door" style="background-image: url('/images/2.png')">
          ...
          <swiper-slide class="wall">
            ...
            <ion-card class="door" style="background-image: url('/images/4.png')">
              ...
              <ion-card-header>
                ...
                <ion-card-subtitle color="light">Judas Escariotes com Judá</ion-card-subtitle>
            </ion-card-header>
            </ion-card>
          ...
          <swiper-slide class="wall">
            ...
            <ion-card class="door" style="background-image: url('/images/10.png')">
              ...
              <ion-card-header>
                ...
                <ion-card-subtitle color="light">João Evangelista com Zebulom</ion-card-subtitle>
            </ion-card-header>
            </ion-card>
            ...
            <ion-card class="door" style="background-image: url('/images/12.png')">
              ...
              <ion-card-header>
                ...
                <ion-card-subtitle color="light">Simão Zelote com Benjamim</ion-card-subtitle>
            </ion-card-header>
            </ion-card>
...
#walls {
  ...
  background: radial-gradient(circle, rgba(29,211,226,1) 0%, rgba(18,127,247,1) 100%);
  height: 100%;
  display: flex;
